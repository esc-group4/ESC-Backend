...
('Benny', 'benny@example.com', 1, 'abc123', NULL, "password"),
('Daniel', 'daniel@example.com', 1, 'abc127', NULL, "password"),
('Albert', 'albert@example.com', 1, 'abc128', NULL, "password"),
('Javier Tan', 'javiertan@example.com', 2, 'abc124', NULL, "password"),
('Xiaoyang', 'hoxiaoyang321@gmail.com', 3, 'abc125', 89116194, "password"),
('Emma Lee', 'emma@example.com', 4, 'abc126', 91234567, "password"),
('Michael Tan', 'michael@example.com', 5, 'abc129', 92345678, "password"),
('Sarah Wong', 'sarah@example.com', 6, 'abc130', 93456789, "password"),
('David Lim', 'david@example.com', 7, 'abc131', 94567890, "password"),
('Lisa Ng', 'lisa@example.com', 8, 'abc132', 95678901, "password"),
('Ryan Goh', 'ryan@example.com', 9, 'abc133', 96789012, "password"),
('Olivia Chua', 'olivia@example.com', 10, 'abc134', 97890123, "password"),
('Ethan Teo', 'ethan@example.com', 11, 'abc135', 98901234, "password"),
('Sophia Koh', 'sophia@example.com', 1, 'abc136', 99012345, "password"),
('William Yeo', 'william@example.com', 2, 'abc137', 90123456, "password"),
('Isabella Tan', 'isabella@example.com', 3, 'abc138', 91234568, "password"),
('James Lee', 'james@example.com', 4, 'abc139', 92345679, "password"),
('Mia Lim', 'mia@example.com', 5, 'abc140', 93456780, "password"),
('Benjamin Ng', 'benjamin@example.com', 6, 'abc141', 94567891, "password"),
('Charlotte Goh', 'charlotte@example.com', 7, 'abc142', 95678902, "password"),
('Lucas Chua', 'lucas@example.com', 8, 'abc143', 96789013, "password"),
('Amelia Teo', 'amelia@example.com', 9, 'abc144', 97890124, "password"),
('Henry Koh', 'henry@example.com', 10, 'abc145', 98901235, "password"),
('Ava Yeo', 'ava@example.com', 11, 'abc146', 99012346, "password"),
('Alexander Tan', 'alexander@example.com', 1, 'abc147', 90123457, "password"),
('Evelyn Lee', 'evelyn@example.com', 2, 'abc148', 91234569, "password"),
('Daniel Lim', 'daniel2@example.com', 3, 'abc149', 92345680, "password"),
('Sofia Ng', 'sofia@example.com', 4, 'abc150', 93456781, "password"),
('Matthew Goh', 'matthew@example.com', 5, 'abc151', 94567892, "password"),
('Chloe Chua', 'chloe@example.com', 6, 'abc152', 95678903, "password"),
('Andrew Teo', 'andrew@example.com', 7, 'abc153', 96789014, "password"),
('Zoe Koh', 'zoe@example.com', 8, 'abc154', 97890125, "password"),
('Christopher Yeo', 'christopher@example.com', 9, 'abc155', 98901236, "password"),
('Lily Tan', 'lily@example.com', 10, 'abc156', 99012347, "password"),
('Joseph Lee', 'joseph@example.com', 11, 'abc157', 90123458, "password"),
('Grace Lim', 'grace@example.com', 1, 'abc158', 91234570, "password"),
('Samuel Ng', 'samuel@example.com', 2, 'abc159', 92345681, "password"),
('Audrey Goh', 'audrey@example.com', 3, 'abc160', 93456782, "password"),
('Dylan Chua', 'dylan@example.com', 4, 'abc161', 94567893, "password"),
('Natalie Teo', 'natalie@example.com', 5, 'abc162', 95678904, "password");
